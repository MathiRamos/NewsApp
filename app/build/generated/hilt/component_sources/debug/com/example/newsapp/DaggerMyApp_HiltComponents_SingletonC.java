...
import com.example.newsapp.di.AppModule_ProvideApiServiceFactory;
import com.example.newsapp.di.AppModule_ProvideAppDatabaseFactory;
import com.example.newsapp.di.AppModule_ProvideBaseUrlFactory;
import com.example.newsapp.di.AppModule_ProvideFavoriteArticleDaoFactory;
import com.example.newsapp.di.AppModule_ProvideNewsRepositoryFactory;
import com.example.newsapp.di.AppModule_ProvideRetrofitFactory;
import com.example.newsapp.di.DataStoreModule;
import com.example.newsapp.di.DataStoreModule_ProvideThemePreferenceManagerFactory;
import com.example.newsapp.ui.detail.DetailViewModel;
import com.example.newsapp.ui.detail.DetailViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.newsapp.ui.favorites.FavoritesViewModel;
import com.example.newsapp.ui.favorites.FavoritesViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.newsapp.ui.home.HomeViewModel;
import com.example.newsapp.ui.home.HomeViewModel_HiltModules_KeyModule_ProvideFactory;
import com.example.newsapp.ui.settings.SettingsViewModel;
import com.example.newsapp.ui.settings.SettingsViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerMyApp_HiltComponents_SingletonC {
  ...
  private static final class ViewModelCImpl extends MyApp_HiltComponents.ViewModelC {
    ...
    public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
      return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(4).put("com.example.newsapp.ui.detail.DetailViewModel", ((Provider) detailViewModelProvider)).put("com.example.newsapp.ui.favorites.FavoritesViewModel", ((Provider) favoritesViewModelProvider)).put("com.example.newsapp.ui.home.HomeViewModel", ((Provider) homeViewModelProvider)).put("com.example.newsapp.ui.settings.SettingsViewModel", ((Provider) settingsViewModelProvider)).build();
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.newsapp.ui.detail.DetailViewModel 
          return (T) new DetailViewModel(singletonCImpl.provideNewsRepositoryProvider.get(), singletonCImpl.favoriteArticleDao());

          case 1: // com.example.newsapp.ui.favorites.FavoritesViewModel 
          return (T) new FavoritesViewModel(singletonCImpl.provideNewsRepositoryProvider.get());

          case 2: // com.example.newsapp.ui.home.HomeViewModel 
          return (T) new HomeViewModel(singletonCImpl.provideNewsRepositoryProvider.get());

          case 3: // com.example.newsapp.ui.settings.SettingsViewModel 
          return (T) new SettingsViewModel(singletonCImpl.provideThemePreferenceManagerProvider.get());
  ...
  private static final class SingletonCImpl extends MyApp_HiltComponents.SingletonC {
    ...
    private FavoriteArticleDao favoriteArticleDao() {
      return AppModule_ProvideFavoriteArticleDaoFactory.provideFavoriteArticleDao(provideAppDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideThemePreferenceManagerProvider = DoubleCheck.provider(new SwitchingProvider<ThemePreferenceManager>(singletonCImpl, 4));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.newsapp.data.repository.NewsRepository 
          return (T) AppModule_ProvideNewsRepositoryFactory.provideNewsRepository(singletonCImpl.provideApiServiceProvider.get(), singletonCImpl.provideAppDatabaseProvider.get());

          case 1: // com.example.newsapp.data.network.ApiService 
          ...
          case 3: // com.example.newsapp.data.local.AppDatabase 
          ...
          case 4: // com.example.newsapp.data.preferences.ThemePreferenceManager 
          return (T) DataStoreModule_ProvideThemePreferenceManagerFactory.provideThemePreferenceManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
